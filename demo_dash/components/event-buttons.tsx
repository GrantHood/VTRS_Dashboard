...
const events = [
  { id: 1, label: "Event 1", topic: "event1", color: "from-primary to-primary/60" },
  { id: 2, label: "Event 2", topic: "event2", color: "from-accent to-accent/60" },
  { id: 3, label: "Event 3", topic: "event3", color: "from-chart-3 to-chart-3/60" },
  { id: 4, label: "Event 4", topic: "event4", color: "from-chart-4 to-chart-4/60" },
